...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/misty-term-c0e6
```

A live public deployment of this template is available at [https://misty-term-c0e6.templates.workers.dev](https://misty-term-c0e6.templates.workers.dev)
